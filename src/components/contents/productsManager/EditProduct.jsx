        ...
        <div className="product-category">
          <div className="old-wrapper content">
            <div className="header">
              <h2 className="title">Thêm 1 sản phẩm mới</h2>
              <p className="desc">
                      ...
                      {loading
                        ...
                        : categorys.map((item) => (
                            <li
                              ...
                              onClick={() => dispatch(listSubCategory(item.id))}
                            >
                              <p
                    ...
                    <ul className="scroll-item">
                      {loading1
                        ...
                        : subCategories.map((item) => (
                            <li
                              key={item.id}
                              className="category-item category-item"
                              onClick={() =>
                            ...
                            >
                              <p
                                className="text-overflow"
                                onClick={() => setSubProductId(item.id)}
                              >
          ...
          <div className="product-basic-info">
            <div className="container">
              ...
              <div className="grid edit-row description-wrap">
                ...
                <div className="edit-input edit-main">
                  <div
                    className="description product-edit-form-item"
                    autosize=""
                    maxrows="26"
                    minrows="9"
                  >
