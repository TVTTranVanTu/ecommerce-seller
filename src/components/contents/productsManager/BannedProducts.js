                        ...
                        Lịch sử đã xóa
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                <path d="M9.18933983,8 L5.21966991,11.9696699 C4.9267767,12.2625631 4.9267767,12.7374369 5.21966991,13.0303301 
                                    ...
                                    5.21966991,2.96966991 C4.9267767,3.26256313 4.9267767,3.73743687 5.21966991,4.03033009 L9.18933983,8 Z"></path>
                            </svg>
                        </i>
                    </div>
                </div>
                <div className="grid filter">
                    <div className="banned-search-container">
                        <div className="shopee-input-group">
                            <span className="shopee-input-group__prepend">
                                <div className="shopee-select">
                                    <div tabIndex="0" className="shopee-selector shopee-selector--normal">
                                        ...
                                        <div className="shopee-selector__suffix">
                                            <i className="shopee-selector__suffix-icon shopee-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                                    <path d="M8,9.18933983 L4.03033009,5.21966991 C3.73743687,4.9267767 3.26256313,4.9267767 2.96966991,5.21966991 
                                                    ...
                                                    13.0303301,5.21966991 C12.7374369,4.9267767 12.2625631,4.9267767 11.9696699,5.21966991 L8,9.18933983 Z"></path>
                                                </svg>
                                            </i>
                                        </div>
                                    </div>
                        ...
                        <div className="banned-search-violation">
                            <span className="banned-search-violation-label">Loại vi phạm</span>
                            <div className="banned-search-violation-select">
                                <div className="shopee-select" min-width="325">
                                    <div tabIndex="0" className="shopee-selector shopee-selector--normal">
                                        <div className="shopee-selector__inner placeholder line-clamp--1"> Chọn</div>
                                        <div className="shopee-selector__suffix">
                                            <i className="shopee-selector__suffix-icon shopee-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                                    <path d="M8,9.18933983 L4.03033009,5.21966991 C3.73743687,4.9267767 3.26256313,4.9267767 2.96966991,5.21966991 
                                    ...
                                    <div className="shopee-popper" style={{ display: "none" }}>
                                        <div className="shopee-select__menu" >
                                            <div className="shopee-scrollbar">
                                                <div className="shopee-scrollbar__wrapper">
                                                    <div className="shopee-scrollbar__bar vertical">
                                                        <div className="shopee-scrollbar__thumb" >
                                                        </div>
                                                    </div>
                                                    <div className="shopee-scrollbar__content" >
                                                        <div className="shopee-select__options">
                    ...
                    <div className="btns">
                        ...
                        <button type="button" className="reset-btn shopee-button shopee-button--normal">
                            <span>
                                Nhập Lại
                            </span>
                        </button>
                            ...
                            <div className="fixed-container" >
                                <div className="product-list-item product-list-header ">
                                    <div className="product-list-item__td product-main product-list-header-item">
                                        <div className="product-list-header-item">
                                            Tên sản phẩm
                                        </div>
                                    </div>
