...
function Order(props) {
  ...
  const searchOrders = () => {
    const filterOrders = listOrders.filter((order) => {
  ...
  const changeAllStatusHandle = () => {
    listOrders &&
      listOrders.map((item) => {
        dispatch(editStatusAction(item.itemId, "AWAITING_SHIPMENT"));
      });
  };
  return (
    <div className="fulfillment-order-page-content">
      <div className="order-list">
          ...
          <div className="order-panel-header">
            ...
            <div className="more-action">
              <div className="tab-buttons">
                <button
                  type="button"
                  className="ship-btn shopee-button shopee-button--primary shopee-button--large"
                  onClick={changeAllStatusHandle}
                >
                  <i className="shopee-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                      <path
                        d="M4.035 4h7.923l-.238-1.105a.5.5 0 0 0-.49-.395H4.763a.5.5 0 0 0-.489.395L4.035 4zm9.471.065A2 2 0 0 1 15 6v7a2 
                              ...
                              3h2.5a.75.75 0 1 1 0 1.5h-2.5a.75.75 0 1 1 0-1.5z"
                      ></path>
                    </svg>
                  </i>
        ...
        <div className="order-list-pannel ">
          <div className="order-list-section list">
            <div className="shopee-fixed-top-card">
              <div className="fixed-container">
                <div className="order-list-header">
                  ...
                  <span className="item-status">Trạng thái</span>
                  <span className="item-countdown">Thời gian đặt hàng</span>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 94 93">
                      ...
                      >
                        ...
                        <path
                          fill="#FFF"
                          stroke="#D8D8D8"
                          d="M79,55.5384191 L79,84.1647059 C79,85.1783108 78.1452709,86 77.0909091,86 L17.9090909,86 C16.8547291,86 16,85.1783108 16,84.1647059 L16,9.83529412 
                            C16,8.82168917 16.8547291,8 17.9090909,8 L77.0909091,8 C78.1452709,8 79,8.82168917 79,9.83529412 L79,43.6504538 L79,55.5384191 Z"
                        ></path>
                        <path
                          fill="#FAFAFA"
                          stroke="#D8D8D8"
                          d="M64.32,4.0026087 L56.62,4.0026087 L56.62,3.5026087 C56.62,2.92262436 56.214985,2.5 55.68,2.5 L40.32,2.5 C39.785015,2.5 
                            ...
                            31.433015,13.02 31.68,13.02 L64.32,13.02 C64.566985,13.02 64.78,12.7977235 64.78,12.5182609 L64.78,4.50434783 C64.78,4.22488523 64.566985,4.0026087 64.32,4.0026087 Z"
                        ></path>
                        <g fill="#D8D8D8" transform="translate(83)">
                          <circle cx="10" cy="13" r="3" opacity=".5"></circle>
                          <circle cx="2" cy="9" r="2" opacity=".3"></circle>
                          <path
                            d="M8.5,1 C7.67157288,1 7,1.67157288 7,2.5 C7,3.32842712 7.67157288,4 8.5,4 C9.32842712,4 10,3.32842712 10,2.5 C10,1.67157288 9.32842712,1 8.5,1 Z M8.5,7.10542736e-15 
                                C9.88071187,7.10542736e-15 11,1.11928813 11,2.5 C11,3.88071187 9.88071187,5 8.5,5 C7.11928813,5 6,3.88071187 6,2.5 C6,1.11928813 7.11928813,7.10542736e-15 8.5,7.10542736e-15 Z"
                            opacity=".3"
                          ></path>
                        </g>
                        <path
                          fill="#D8D8D8"
                          d="M48.5,43 C48.7761424,43 49,43.2238576 49,43.5 C49,43.7761424 48.7761424,44 48.5,44 L26.5,44 C26.2238576,44 26,43.7761424 26,43.5 C26,43.2238576 26.2238576,43 
                            ...
                            L68.5,34 Z M68.5,25 C68.7761424,25 69,25.2238576 69,25.5 C69,25.7761424 68.7761424,26 68.5,26 L26.5,26 C26.2238576,26 26,25.7761424 26,25.5 C26,25.2238576 26.2238576,25 26.5,25 L68.5,25 Z"
                        ></path>
                      </g>
                    </svg>
                  </i>
